...
<?php
    ...
    // compute the heuristic sets, k+, k-, k?
    $k_plus = array();
    $k_minus = array();
    $k_ques = array();
    ...
    echo "<br>The heuristic sets are given below: <br>";
    echo "K<sup>-</sup> = {";
    foreach($k_minus as $x){
        echo $x.",";
    }
    echo "}<br>";
    echo "K<sup>+</sup> = {";
    ...
    echo "}<br>";
    // create k+Uk? array and pass into calcsubsets
    $union_set = array_merge($k_plus, $k_ques);
    echo "K<sup>+</sup> UNION K<sup>?</sup> = {";
    foreach($union_set as $x){
        echo $x.",";
    }
    echo "}<br>";
    ...
    echo "<br>";
    echo "The closure sets of each subset of attributes in the K<sup>+</sup> and K<sup>?</sup> are as follows: <br>";
    $closures = array();
